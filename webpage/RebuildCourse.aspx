<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RebuildCourse.aspx.cs" Inherits="AcademicSystem.webpage.RebuildCourse" %>
    ...
    <div class="container container-func sl_all_bg" id="yhgnPage">
		<div class="panel panel-info">
	        ...
	        <div class="panel-body" >
				...
				<asp:BoundField HeaderText="课程类型" DataField="课程类型" HeaderStyle-CssClass="gridview-header" />  
				<asp:BoundField HeaderText="总学分" DataField="总学分" HeaderStyle-CssClass="gridview-header" />                     
                <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="gridview-header">
            <ItemTemplate >
                <asp:Button ID="Button1"  runat="server" Text="申请重修" CssClass="btn_blue" CommandName = "ButtonCommand" CommandArgument = '<%# Container.DataItemIndex %>' />
            </ItemTemplate>
        </asp:TemplateField>
